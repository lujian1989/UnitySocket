...
public class SocketClient
{
    ...
    public void SendMessageToServer(byte[] data)
    {
        ...
        Debug.Log("SendMessageToServer:"+data.Length+" "+this.connection.Connected);
        ...
        this.connection.BeginSend(data, 0, data.Length, SocketFlags.None,
            new AsyncCallback(this.SendMessageToServerComplete), this.connection);
    }
    ...
    private void Connected(IAsyncResult iar)
    {
        try
        {
            ...
            this.connection.BeginReceive(array, 0, bufferSize, SocketFlags.None, new AsyncCallback(this.KeepConnect),
                array);
        }
    ...
    private void KeepConnect(IAsyncResult iar)
    {
        try
        {
            ...
            if (num > 0)
            {
                ...
                this.connection.BeginReceive(array, 0, bufferSize, SocketFlags.None,
